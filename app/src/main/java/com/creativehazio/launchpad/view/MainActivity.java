...
import com.creativehazio.launchpad.fragment.AllFragment;
import com.creativehazio.launchpad.fragment.FinanceFragment;
import com.creativehazio.launchpad.fragment.HealthFragment;
import com.creativehazio.launchpad.fragment.HobbyFragment;
import com.creativehazio.launchpad.fragment.OtherFragment;
import com.creativehazio.launchpad.fragment.PersonalFragment;
import com.creativehazio.launchpad.fragment.WorkFragment;
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.nav_other:
                ...
                closeDrawer();
                return true;
            case R.id.nav_video_transcript:
                startActivity(new Intent(MainActivity.this, VideoTranscriptActivity.class));
                return true;
            case R.id.nav_audio_transcript:
                startActivity(new Intent(MainActivity.this, AudioTranscriptActivity.class));
                return true;
            case R.id.nav_summarizer:
                startActivity(new Intent(MainActivity.this, TextSummarizerActivity.class));
                return true;
