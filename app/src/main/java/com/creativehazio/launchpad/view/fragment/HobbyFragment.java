...
public class HobbyFragment extends Fragment {
    ...
    private ArrayList<Note> hobbyNoteList;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        hobbyNoteList = (ArrayList<Note>) viewModel.getNotesByCategory(getString(R.string.hobby))
                .getValue();
        NoteSorter.sort(hobbyNoteList);

        recyclerView = view.findViewById(R.id.recycler_view);
        adapter = new NoteListAdapter(getContext(), hobbyNoteList);
        ...
        adapter.setListener(new NoteListAdapter.Listener() {
            ...
            public void onLongClick(ArrayList<Note> noteArrayList, int position) {
                DeleteAlertDialogForCategories.deleteNote(getContext(),
                        viewModel, adapter, position, noteArrayList,getString(R.string.hobby));
            }
        });
    ...
    public void onStart() {
        super.onStart();
        viewModel.getNotesByCategory(getString(R.string.hobby)).observe(this, notes -> {
            hobbyNoteList = (ArrayList<Note>) notes;
            NoteSorter.sort(hobbyNoteList);
            adapter.refreshNoteArrayList(hobbyNoteList);
        });
    }
