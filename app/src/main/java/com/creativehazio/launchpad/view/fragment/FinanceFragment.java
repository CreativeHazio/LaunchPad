...
public class FinanceFragment extends Fragment {
    ...
    private ArrayList<Note> financeNoteList;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        financeNoteList = (ArrayList<Note>) viewModel.getNotesByCategory(getString(R.string.finance))
                .getValue();
        NoteSorter.sort(financeNoteList);

        recyclerView = view.findViewById(R.id.recycler_view);
        adapter = new NoteListAdapter(getContext(), financeNoteList);
        ...
        adapter.setListener(new NoteListAdapter.Listener() {
            ...
            public void onLongClick(ArrayList<Note> noteArrayList, int position) {
                DeleteAlertDialogForCategories.deleteNote(getContext(),
                        viewModel, adapter, position, noteArrayList,getString(R.string.finance));
            }
        });
    ...
    public void onStart() {
        super.onStart();
        viewModel.getNotesByCategory(getString(R.string.finance)).observe(this, notes -> {
            financeNoteList = (ArrayList<Note>) notes;
            NoteSorter.sort(financeNoteList);
            adapter.refreshNoteArrayList(financeNoteList);
        });
    }
