...
public class DeleteAlertDialogForCategories {
    ...
    public static void deleteNote(Context context, MainActivityViewModel viewModel,
                                  ...
                                  ArrayList<Note> noteArrayList, String category) {
        ...
        builder.setPositiveButton("Delete", (DialogInterface.OnClickListener) (dialog, which) -> {
            ...
            viewModel.getNotesByCategory(category).observe((LifecycleOwner) context, new Observer<List<Note>>() {
                @Override
