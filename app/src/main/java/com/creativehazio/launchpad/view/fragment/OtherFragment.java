...
public class OtherFragment extends Fragment {
    ...
    private ArrayList<Note> otherNoteList;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        otherNoteList = (ArrayList<Note>) viewModel.getNotesByCategory(getString(R.string.other))
                .getValue();
        NoteSorter.sort(otherNoteList);

        recyclerView = view.findViewById(R.id.recycler_view);
        adapter = new NoteListAdapter(getContext(), otherNoteList);
        ...
        adapter.setListener(new NoteListAdapter.Listener() {
            ...
            public void onLongClick(ArrayList<Note> noteArrayList, int position) {
                DeleteAlertDialogForCategories.deleteNote(getContext(),
                        viewModel, adapter, position, noteArrayList,getString(R.string.other));
            }
        });
    ...
    public void onStart() {
        super.onStart();
        viewModel.getNotesByCategory(getString(R.string.other)).observe(this, notes -> {
            otherNoteList = (ArrayList<Note>) notes;
            NoteSorter.sort(otherNoteList);
            adapter.refreshNoteArrayList(otherNoteList);
        });
    }
